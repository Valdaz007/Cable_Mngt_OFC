...
<body>
    ...
    <input id="oltsData" type="hidden" style="display:none;" data-olts='<?php echo getOLTs(); ?>'>
    <input id="jbsData" type="hidden" style="display:none;" data-jbs='<?php echo getJBs(); ?>'>
    <input id="cablesData" type="hidden" style="display:none;" data-cables='<?php echo getCables(); ?>'>
